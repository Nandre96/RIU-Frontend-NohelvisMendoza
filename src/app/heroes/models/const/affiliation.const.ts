...
import { AffiliationInfo } from '../interfaces/affiliation.interface';

export const JUSTICE_LEAGUE_AFFILIATION_INFO: AffiliationInfo = {
...
export const BAT_FAMILY_AFFILIATION_INFO: AffiliationInfo = {
...
export const GREEN_LANTERN_CORPS_AFFILIATION_INFO: AffiliationInfo = {
...
export const AVENGERS_AFFILIATION_INFO: AffiliationInfo = {
...
export const FANTASTIC_FOUR_AFFILIATION_INFO: AffiliationInfo = {
...
export const ILLUMINATI_AFFILIATION_INFO: AffiliationInfo = {
...
export const DEFENDERS_AFFILIATION_INFO: AffiliationInfo = {
...
export const X_MEN_AFFILIATION_INFO: AffiliationInfo = {
...
export const SHIELD_AFFILIATION_INFO: AffiliationInfo = {
...
export const GUARDIANS_OF_THE_GALAXY_AFFILIATION_INFO: AffiliationInfo = {
...
export const UNKNOWN_AFFILIATION_INFO: AffiliationInfo = {
...
export const AFILIACIONES_INFO: Record<AffiliationEnum, AffiliationInfo> = {
