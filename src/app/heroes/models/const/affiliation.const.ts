...
export const AFFILIATION_OPTIONS: ReadonlyArray<Readonly<AffiliationView>> = [
  JUSTICE_LEAGUE_AFFILIATION_INFO,
  BAT_FAMILY_AFFILIATION_INFO,
  GREEN_LANTERN_CORPS_AFFILIATION_INFO,
  AVENGERS_AFFILIATION_INFO,
  FANTASTIC_FOUR_AFFILIATION_INFO,
  ILLUMINATI_AFFILIATION_INFO,
  DEFENDERS_AFFILIATION_INFO,
  X_MEN_AFFILIATION_INFO,
  SHIELD_AFFILIATION_INFO,
  GUARDIANS_OF_THE_GALAXY_AFFILIATION_INFO,
